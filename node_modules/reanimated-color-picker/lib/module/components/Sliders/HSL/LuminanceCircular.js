...
export function LuminanceCircular({ children, gestures = [], style = {}, containerStyle = {}, rotate = 0, ...props }) {
  ...
  const thumbSide = useSharedValue(0); // to determine in which side of the circle the thumb is
